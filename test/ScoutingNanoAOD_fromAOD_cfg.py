...
# Get the era specified by the user
era = params.era
...
process.mmtree = cms.EDAnalyzer('ScoutingNanoAOD_fromAOD' if era in ["2022","2023","2024"] else 'ScoutingNanoAOD_fromAOD',
    doL1              = cms.bool(False),
...
# else:
process.p = cms.Path(process.patDefaultSequence * process.puppi  * process.ak4PFJetsPuppi * process.ak4PFPuppiL2L3CorrectorSeq * process.ak8PFPuppiL2L3CorrectorSeq * process.ak8PFHLTL2L3CorrectorSeq *  process.ak4PFHLTL2L3CorrectorSeq * process.fullPatMetSequenc * process.mmtree)
#process.p = cms.Path(process.patDefaultSequence * process.puppi  * process.ak4PFJetsPuppi * process.ak8PFJetsPuppi * process.ak4PFPuppiL2L3CorrectorSeq * process.ak8PFPuppiL2L3CorrectorSeq * process.ak8PFHLTL2L3CorrectorSeq *  process.ak4PFHLTL2L3CorrectorSeq * process.fullPatMetSequenc * process.mmtree)
