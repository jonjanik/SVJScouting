...
public:
    ...
    JetWithJECPairReco(const reco::PFJet* j, double s, int idx , const Run3ScoutingPFJet* scouting_j) : first(j), second(s), third(idx), fourth(scouting_j) {}
    ...
    inline void scout_jet(const Run3ScoutingPFJet* scouting_j) { fourth = scouting_j; }
...
bool ScoutingNanoAOD_fromMiniAOD::jetID(const Run3ScoutingPFJet &pfjet){
// https://twiki.cern.ch/twiki/bin/view/CMS/JetID13TeVRun2018
    //moved HT cut
    TLorentzVector jet; 
